<script>
  ...
  const responseMap = {
    ...
    'the': "Where ancient relics find their home, preserved for all to explore and roam. Exhibits rich with history's trace, guide you to this hallowed place. Feel free to enjoy the exhibitions until 1:15pm before heading to your next location.",
    ...
    'world.': "Russell Square's greenery hides, a green lock that your key's use abides. From humble origins did it start, that metal prize must play its part. When boughs with purple blossoms bloom, a vivid scene for all to consume.",
    ...
    'please': "Where shooting sports and oak-aged vintages meet, retrace your love's first tender heartbeats. A tavern feast where romance took aim, let cherished archives reignite that flame. Relive the scene that started your trail, over pints and plates, a timeless tale. Dinner is at 4pm",
    'you': " Put together your keywords, minus the 'start', and you will hear these words from my hearts. Our game is done, here's the final clue, this sentence reveals, my message to you. The next phase awaits, our future to write, Let love's radiant question take flight. This foreshore bred infinite joys in its wake, now let new vows be joyfully stake. The trail concludes where it first did start, united, we'll embark when two become one heart.",
    'clear': 'A fresh start',
  };
