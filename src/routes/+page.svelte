...
<div class=" min-h-screen flex flex-col items-center bg-yellow-200">
  <h1 class="text-5xl md:text-6xl barlow-semi-condensed-extrabold-italic text-blue-950 my-4">Tall Tree Adventures</h1>
